...
class MultiWaveletConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, level, size, wavelets=['db1', 'db2', 'db3', 'db4', 'db5', 'db6'], mode='symmetric'):
...
model = WNO2d(levels, size, width, T_in, T_out, state_size, parameter_size)
