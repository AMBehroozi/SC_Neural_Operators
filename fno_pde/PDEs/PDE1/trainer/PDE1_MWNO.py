...
for ep in outer_loop:
    ...
    for batch_data in train_loader:
        ...
        residuals_eq = compute_residual(U_pred, batch_parameters, t_tensor_, x_tensor_)
        ...
        train_pde_loss_accumulated += eq_loss.item() * batch_size_
    ...
    epoch_pdeloss = train_pde_loss_accumulated / len(train_loader.dataset)
    
    train_fnolosses.append(epoch_fnoloss)
    train_iglosses.append(epoch_igloss)
    train_pdelosses.append(epoch_pdeloss)
